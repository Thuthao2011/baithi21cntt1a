    ...
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered">
                ...
                <a href="{{ route('product.getCateAdd') }}" class="btn btn-success" style="margin-bottom: 15px;">Thêm Danh Mục</a>
                 </a>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img width="260" height="260" src="{{ asset('source/image/product/' . $category->image) }}" alt=""></td>

                        <td>
                        
                            <a href="{{ route('product.getCateEdit', ['id' => $category->id]) }}" class="btn btn-primary">Sửa</a>
                        </td>
                        <td>               
                        <form action="{{ route('categories.getCateDelete', $category->id) }}" method="post">
                        @csrf
