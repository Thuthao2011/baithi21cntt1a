...
class PageController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $products = Product::all();
        $user = auth()->user();
        $favoriteProducts = $user->products;
    
        $isFavorite = $favoriteProducts->contains('id', $product->id);
    
        return view('product.show', compact('product', 'products', 'new_products', 'categories', 'user', 'favoriteProducts', 'isFavorite'));
    }
    ...
    public function store(Request $request)
{
    ...
    public function removeFromCart($id)
    {
        ...
        public function checkout()
        {
            ...
            return view('product.checkout',compact('categories'));
        }
